...
export const SCRIPT_CENTRAL_BASE_URL = `${API_BASE_URL}scripts-central/view?id={SCRIPT_ID}&params=context,query&query={SCRIPT_CODE}&context=WORKFLOW_SCRIPT&filterText={SCRIPT_CODE}&currentContext=WORKFLOW_SCRIPT&popup=0`; 