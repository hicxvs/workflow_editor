...
export const API_BASE_URL = (IS_APP_IN_MODE_DEV) ? import.meta.env.VITE_API_BASE_URL : `${window.location.origin}${(window.location.pathname).split('/app')[0]}/app`;
...
export const API_RESOURCE_DRAFT_ENDPOINT = import.meta.env.VITE_API_RESOURCE_DRAFT_ENDPOINT || '/rest/api/v2/workflow/definition/draft';
...
export const API_RESOURCE_SCRIPT_ENDPOINT = import.meta.env.VITE_API_RESOURCE_SCRIPT_ENDPOINT || '/rest/api/v2/workflow/definition/script';
